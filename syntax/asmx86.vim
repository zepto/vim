...
syn region asmx86Commentnasm	start=";" end="$" contains=asmx86Todo
...
syn match asmx86Reg	"%[s]t([01234567])"
...
syn match asmx86Opcode_mv	"\<f[i]\?st[p]\?[ls]\?\s"
syn match asmx86Opcode_mv	"\<fst[cs]\?w\s"
syn match asmx86Opcode_mv	"\<f[i]\?ld[slq]\?\s"
syn match asmx86Opcode_mv	"\<fld\(\(cw\)\|\(pi\)\|[z1]\)\>"
syn match asmx86Opcode_mv       "\<ffree\s"
syn match asmx86Opcode_mv	"\<fxch\s"
syn match asmx86Opcode          "\<ftst\s"
syn match asmx86Opcode          "\<finit\s"
syn match asmx86Opcode          "\<fabs\s"
syn match asmx86Opcode          "\<fchs\s"
syn match asmx86Opcode          "\<fsqrt\s"
syn match asmx86Opcode          "\<fscale\s"
syn match asmx86Opcode          "\<frndint\s"
syn match asmx86Opcode          "\<fsqrt\s"
syn match asmx86Opcode          "\<f[i]\?div[r]\?[sl]\?\s"
syn match asmx86Opcode          "\<fdiv[r]\?[p]\?\s"
syn match asmx86Opcode          "\<f[i]\?mul[sl]\?\s"
syn match asmx86Opcode          "\<fmul[p]\?\s"
syn match asmx86Opcode          "\<f[i]\?sub[r]\?[sl]\?\s"
syn match asmx86Opcode          "\<fsub[r]\?[p]\?\s"
syn match asmx86Opcode          "\<f[i]\?add[sl]\?\s"
syn match asmx86Opcode          "\<fadd[p]\?\s"

syn match asmx86Opcode          "\<f[i]\?com[p]\?\s"
syn match asmx86Opcode          "\<fcomp[p]\?\s"
syn match asmx86Opcode          "\<fcomi[p]\?\s"
...
syn region asmx86String		matchgroup=Normal start=+'+ end=+'+ skip=+\\\\\|\\'+ contains=asmx86CharError
syn region asmx86String		matchgroup=Normal start=+"+ end=+"+ skip=+\\\\\|\\"+ contains=asmx86CharError

syn match asmx86CharError	"[^ -~]" contained

" Immediate data
syn match asmx86Immediate	"\$[[:alnum:][:punct:]]\+\>" contains=hexNumber
...
if version >= 508 || !exists("did_asmx86_syntax_inits")
  ...
  HiLink asmx86Commentnasm	Comment
  ...
  HiLink asmx86Immediate	String	" Statement
